...
public class ID3v2Test extends MP3TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        expectFramesSet = new Vector();
        expectFrames = new Hashtable();

        ID3v2Frame tit2 = new ID3v2Frame("TIT2", "\0Title"
        ...
        ID3v2Frame tpe1 = new ID3v2Frame("TPE1", "\0Artist"
                .getBytes("Cp437"), false, false, false,
                ID3v2Frame.NO_COMPRESSION, (byte) 0, (byte) 0);
        expectFramesSet.add(tpe1);
        expectFrames.put("TPE1", tpe1);

        ID3v2Frame talb = new ID3v2Frame("TALB", "\0Album"
                .getBytes("Cp437"), false, false, false,
                ID3v2Frame.NO_COMPRESSION, (byte) 0, (byte) 0);
        expectFramesSet.add(talb);
        expectFrames.put("TALB", talb);

        ID3v2Frame tyer = new ID3v2Frame("TYER", "\0002003"
                .getBytes("Cp437"), false, false, false,
                ID3v2Frame.NO_COMPRESSION, (byte) 0, (byte) 0);
        expectFramesSet.add(tyer);
        expectFrames.put("TYER", tyer);

        ID3v2Frame trck = new ID3v2Frame("TRCK", "\0001"
                .getBytes("Cp437"), false, false, false,
                ID3v2Frame.NO_COMPRESSION, (byte) 0, (byte) 0);
        expectFramesSet.add(trck);
        expectFrames.put("TRCK", trck);

        ID3v2Frame tcon = new ID3v2Frame("TCON", "\0Rock"
                .getBytes("Cp437"), false, false, false,
                ID3v2Frame.NO_COMPRESSION, (byte) 0, (byte) 0);
        expectFramesSet.add(tcon);
        expectFrames.put("TCON", tcon);

        ID3v2Frame comm = new ID3v2Frame("COMM",
                "\0engShort\0Long comment".getBytes("Cp437"), false,
                false, false, ID3v2Frame.NO_COMPRESSION, (byte) 0,
                (byte) 0);
        ...
        byte[] binContent = { (byte) 42, (byte) 10, (byte) 2,
                (byte) 12, (byte) 255, (byte) 0, (byte) 17 };
        ID3v2Frame xbin = new ID3v2Frame("XBIN", binContent, false,
                false, false, ID3v2Frame.NO_COMPRESSION, (byte) 0,
                (byte) 0);
    ...
    public void testSynchronize() {
        // no sync
        byte[] test = { (byte) 10, (byte) 255, (byte) 30, (byte) 10,
    ...
    public void testUnynchronize() {
        ...
        byte[] test = { (byte) 10, (byte) 240, (byte) 30, (byte) 10,
                (byte) 12, (byte) 42, (byte) 42, (byte) 2 };
        ...
        byte[] test3 = { (byte) 10, (byte) 255, (byte) 0, (byte) 10,
                (byte) 12, (byte) 42, (byte) 42, (byte) 2 };
        ...
        // multiple unsynchs
        byte[] test5 = { (byte) 10, (byte) 255, (byte) 0, (byte) 10,
                (byte) 12, (byte) 255, (byte) 230, (byte) 2 };
    ...
    public void testAddFrame() throws Exception {
        ...
        Vector res = id3v2.getFrame("TPE1");
        Vector expect = new Vector();
        expect.add(expectFrames.get("TPE1"));
        assertEquals(expect, res);

        id3v2 = new ID3v2((File) testFiles.get("short_v2reg"));
        add = new ID3v2Frame("TPE1", "\0Artist2".getBytes("Cp437"),
                false, false, false, ID3v2Frame.NO_COMPRESSION,
                (byte) 0, (byte) 0);
        id3v2.addFrame(add);
        ...
        expect = new Vector();
        expect.add(expectFrames.get("TPE1"));
        expect.add(new ID3v2Frame("TPE1",
                "\0Artist2".getBytes("Cp437"), false, false, false,
                ID3v2Frame.NO_COMPRESSION, (byte) 0, (byte) 0));
        assertEquals(expect, res);
    ...
    /*
     * Class under test for void removeFrame(String)
     */
    ...
    public void testUpdateNone() throws Exception {
        ...
        for (Enumeration e = expectFramesSet.elements(); e
                .hasMoreElements();) {
    ...
    public void testUpdateNonePadding() throws Exception {
        ...
        assertTrue("Padding was used", ((File) testFiles
                .get("short_none")).length() > 2048);
    }
    ...
    public void testUpdateExPadding() throws Exception {
        ...
        id3v2.setUsePadding(true);
        id3v2.setUseUnsynchronization(false);
        ID3v2Frame add = new ID3v2Frame("TPE1", "\0Artist2"
                .getBytes("Cp437"), false, false, false,
                ID3v2Frame.NO_COMPRESSION, (byte) 0, (byte) 0);
        id3v2.addFrame(add);
        id3v2.update();
        ...
        id3v2 = new ID3v2((File) testFiles.get("short_v2reg"));
        Vector res = id3v2.getFrames();
        Vector expect = (Vector) expectFramesSet.clone();
        expect.add(add);
        assertEquals(expect, res);

        // check that padding was used (file length > 2048)
        assertTrue("Padding was used", ((File) testFiles
                .get("short_v2reg")).length() > 2048);
    }
    ...
    public void testUpdateNoUnsynch() throws Exception {
        ...
        assertTrue("File length is 901 (" + length + ")",
                length == 901L);
    }
