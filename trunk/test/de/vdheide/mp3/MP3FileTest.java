...
public class MP3FileTest extends MP3TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        System.arraycopy(silenceFrame, 0, frameM1L1B160, 0,
                silenceFrame.length);
        frameM1L1B160[1] = (byte) 0xfe;
        frameM1L1B160[2] = (byte) 0x50;
        createMP3("M1L1B160", null, null, 3, leadinM1L1B160,
                frameM1L1B160);
        ...
        System.arraycopy(silenceFrame, 0, frameM1L2B160, 0,
                silenceFrame.length);
        frameM1L2B160[1] = (byte) 0xfc;
        frameM1L2B160[2] = (byte) 0x94;
        createMP3("M1L2B160", null, null, 3, leadinM1L2B160,
                frameM1L2B160);
        ...
        System.arraycopy(silenceFrame, 0, frameM1L3B160, 0,
                silenceFrame.length);
        frameM1L3B160[1] = (byte) 0xfb;
        frameM1L3B160[2] = (byte) 0xa8;
        createMP3("M1L3B160", null, null, 3, leadinM1L3B160,
                frameM1L3B160);
        ...
        System.arraycopy(silenceFrame, 0, frameM2L1B160, 0,
                silenceFrame.length);
        frameM2L1B160[1] = (byte) 0xf6;
        frameM2L1B160[2] = (byte) 0x50;
        createMP3("M2L1B160", null, null, 3, leadinM2L1B160,
                frameM2L1B160);
        ...
        System.arraycopy(silenceFrame, 0, frameM2L2B160, 0,
                silenceFrame.length);
        frameM2L2B160[1] = (byte) 0xf4;
        frameM2L2B160[2] = (byte) 0x94;
        createMP3("M2L2B160", null, null, 3, leadinM2L2B160,
                frameM2L2B160);
        ...
        System.arraycopy(silenceFrame, 0, frameM2L3B160, 0,
                silenceFrame.length);
        frameM2L3B160[1] = (byte) 0xf2;
        frameM2L3B160[2] = (byte) 0xa8;
        createMP3("M2L3B160", null, null, 3, leadinM2L3B160,
                frameM2L3B160);
    ...
    public void testGetMPEGLevel() throws Exception {
        ...
        mp3 = new MP3File(((File) testFiles.get("M1L1B160"))
                .getAbsolutePath());
        assertEquals(1, mp3.getMPEGLevel());

        mp3 = new MP3File(((File) testFiles.get("M1L2B160"))
                .getAbsolutePath());
        assertEquals(1, mp3.getMPEGLevel());

        mp3 = new MP3File(((File) testFiles.get("M1L3B160"))
                .getAbsolutePath());
        assertEquals(1, mp3.getMPEGLevel());

        mp3 = new MP3File(((File) testFiles.get("M2L1B160"))
                .getAbsolutePath());
        assertEquals(2, mp3.getMPEGLevel());

        mp3 = new MP3File(((File) testFiles.get("M2L2B160"))
                .getAbsolutePath());
        assertEquals(2, mp3.getMPEGLevel());

        mp3 = new MP3File(((File) testFiles.get("M2L3B160"))
                .getAbsolutePath());
        assertEquals(2, mp3.getMPEGLevel());
    }
    ...
    public void testGetSetInfo() throws Exception {
        ...
        assertEquals("CopyrightText", mp3.getCopyrightText()
                .getTextContent());
        ...
        assertEquals("Content group", mp3.getContentGroup()
                .getTextContent());
        ...
        assertEquals("Original title", mp3.getOriginalTitle()
                .getTextContent());
        ...
        assertEquals("Commercial information", mp3
                .getCommercialInformation().getTextContent());

        content = new TagContent();
        content.setContent("http://www.gnu.org/lgpl.html");
        mp3.setCopyrightWebpage(content);
        assertEquals("http://www.gnu.org/lgpl.html", mp3
                .getCopyrightWebpage().getTextContent());

        content = new TagContent();
        content.setContent("http://www.web.org/audio.html");
        mp3.setAudioFileWebpage(content);
        assertEquals("http://www.web.org/audio.html", mp3
                .getAudioFileWebpage().getTextContent());

        content = new TagContent();
        content.setContent("http://www.web.org/artist.html");
        mp3.setArtistWebpage(content);
        assertEquals("http://www.web.org/artist.html", mp3
                .getArtistWebpage().getTextContent());
        ...
        assertEquals("http://www.web.org/pay.html", mp3
                .getPaymentWebpage().getTextContent());
        ...
        assertEquals(bin, mp3.getSynchronizedTempoCodes()
                .getBinaryContent());

        content = new TagContent();
        content.setContent(bin);
        mp3.setSynchronizedLyrics(content);
        assertEquals(bin, mp3.getSynchronizedLyrics()
                .getBinaryContent());

        content = new TagContent();
        content.setContent(bin);
        mp3.setRelativeVolumeAdjustment(content);
        assertEquals(bin, mp3.getRelativeVolumenAdjustment()
                .getBinaryContent());
        ...
        assertEquals(bin, mp3.getRecommendedBufferSize()
                .getBinaryContent());

        content = new TagContent();
        content.setContent(bin);
        mp3.setPositionSynchronization(content);
        assertEquals(bin, mp3.getPositionSynchronization()
                .getBinaryContent());
    ...
    public void testGetUniqueFileIdentifier() {
        //TODO Implement getUniqueFileIdentifier().
    }

    public void testSetUniqueFileIdentifier() {
        //TODO Implement setUniqueFileIdentifier().
    }

    public void testGetUserDefinedText() {
        //TODO Implement getUserDefinedText().
    }

    public void testSetUserDefinedText() {
        //TODO Implement setUserDefinedText().
    }

    public void testGetUserDefinedURL() {
        //TODO Implement getUserDefinedURL().
    }

    public void testSetUserDefinedURL() {
        //TODO Implement setUserDefinedURL().
    }

    public void testGetUnsynchronizedLyrics() {
        //TODO Implement getUnsynchronizedLyrics().
    }

    public void testSetUnsynchronizedLyrics() {
        //TODO Implement setUnsynchronizedLyrics().
    }
    ...
    public void testSetPicture() {
        //TODO Implement setPicture().
    }

    public void testGetEncapsulatedObject() {
        //TODO Implement getEncapsulatedObject().
    }

    public void testSetEncapsulatedObject() {
        //TODO Implement setEncapsulatedObject().
    }

    public void testGetTermsOfUse() {
        //TODO Implement getTermsOfUse().
    }

    public void testSetTermsOfUse() {
        //TODO Implement setTermsOfUse().
    }

    public void testGetEncryptionMethodRegistration() {
        //TODO Implement getEncryptionMethodRegistration().
    }

    public void testSetEncryptionMethodRegistration() {
        //TODO Implement setEncryptionMethodRegistration().
    }

    public void testGetGroupIdentificationRegistration() {
        //TODO Implement getGroupIdentificationRegistration().
    }

    public void testSetGroupIdentificationRegistration() {
        //TODO Implement setGroupIdentificationRegistration().
    }
